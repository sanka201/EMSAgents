...
# Objective function: First maximize the number of days Priority 1 load is fully supported
# Then, within those constraints, maximize the use of available energy for Priority 2 and Priority 3
primary_objective = pulp.lpSum([y[d] for d in days])
secondary_objective = pulp.lpSum([x2[d] + x3[d] for d in days])
problem += primary_objective + 0.001 * secondary_objective, "MaximizePriority1SupportAndUseAvailableEnergy"
